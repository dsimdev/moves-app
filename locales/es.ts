export const es = {
  ...
  obHowBody: "Tu sueldo abre un período y tus gastos lo van descontando. Podés sumar cobros al período actual o abrir uno nuevo; al abrir uno, lo que sobró pasa a Ahorros.",
  obTypesTitle: "Tipos de movimiento",
  obTypesBody: "Estos son los que vas a usar:",
  obTypeGasto: "Gasto: lo que sale de tu disponible.",
  obTypeIngreso: "Sueldo: tu ingreso; abre un período o se suma al actual.",
  obTypeMove: "Move: pasás plata de Ahorros a tu disponible.",
  obTypeFx: "USD/EUR: comprás o gastás moneda para tu reserva.",
  obSecurityTitle: "Seguridad y avisos",
  obSecurityBody: "¿Los activás ahora? Podés cambiarlo cuando quieras en Configuración.",
  ...
  obInvestBody: "Lo que no gastás queda en Ahorros. Si invertís, podés llevar una Reserva en dólares o euros y fijar una meta. ¿Mostramos la sección Inversión?",
  obInvestYes: "Sí, activar",
  obInvestNo: "Ahora no",
  obDoneTitle: "¡Todo listo!",
  obDoneBody: "Cargá tu primer movimiento con el botón +. ¡A controlar tu plata!",
